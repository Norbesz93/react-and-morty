    ...
    return(
        <div className='landingPage'>
            ...
            <div className='landingInfo'>
                <button className="btns" onClick={()=>setIsShownCharacters(true)} id="charBtn">Characters</button>
                <p>The above button will introduce you to the Characters</p>
                <hr></hr>
                <button className="btns" onClick={()=>setIsShownLocations(true)} id="locBtn">Locations</button>
